...
public class MediaActivity extends AppCompatActivity {
    ...
    private ArrayList<ScribeImage> images = new ArrayList<>();
...
//
//        private ArrayList<ScribeImage> images;
//
//
//        public ImagesAdapter(ArrayList<ScribeImage> images) {
//            this.images = images;
//        }
//
//        @Override
...
//            final ScribeImage image = images.get(position);
...
//        }
//
//        public void updateUI(ScribeImage image) {
//            // Convert url or json data to image
//            Picasso.with(getBaseContext())
//                    .load("file://" + image.getImgResourceUrl().getPath())
//                    .resize(800,800)
//                    .centerCrop()
//                    .into(imageView);
